...
/**
 * Singleton class for creating a Epub360 SSO Token. See {@link #main(String[])} for usage example.
 * Requires commons-codec library {@link http://commons.apache.org/codec/}.
 */
public class TokenGenerator {
  
  private static final String DOMAIN = "FILL IN";

  private static final String SSO_KEY = "FILL IN";    
  ...
  public static void main(String[] args) {
    try {
      ...
      jsonObj.put("expires", "2019-05-18 17:24:28");
